...
const hallucination =[
  {
    name: 'OpenAI DaVinci Hallucination-Free',
  ...
  return (
    ...
    <div className="bg-white">
      <div className="mx-auto max-w-7xl py-24 px-6 lg:px-8">
        ...
        <h2 className="text-lg mt-8 font-medium leading-6 text-gray-900">NEW: Hallucination Free Language Completion</h2>
        <div className="mt-12 space-y-4 sm:mt-8 sm:grid sm:grid-cols-2 sm:gap-6 sm:space-y-0 lg:mx-auto lg:max-w-4xl xl:mx-0 xl:max-w-none xl:grid-cols-2">
